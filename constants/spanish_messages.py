...
class MsgBrowser():
    ...
    # WINDOW SIZE
    MSG_WINDOW_SIZE = u'Se obtiene las medidas de la ventana. La medida es %s'%__SIZE
...
class MsgSearch():
    ...
    MSG_COMPARE_TEXT_ERROR = u'El texto {0} es diferente al elemento {1}'
...
class MsgImage():
    ...
    MSG_SCREENSHOT_BUFFER = u'Se realiza una captura de pantalla, se deja en memoria'
    MSG_GET_IMAGE = (u'Se pudo obtener la imagen del elemento {0}, '
                     u'se guardo en {1}')
...
class MsgSelect():
    ...
    MSG_SELECT_INDEX = u'Se selecciona la opción del índice {0} del elemento {1}'
    MSG_SELECT_VALUE = u'Se selecciona la opción con valor {0} del elemento {1}'
    ...
    MSG_SELECT_ELEMENT_ERROR = u'El elemento buscado {}, no es un elemento select'
...
class MsgWebelement():
    ...
    MSG_ATTRIBUTE_ERROR = u'No se pudo obtener el atributo {0} del elemento {1}'
